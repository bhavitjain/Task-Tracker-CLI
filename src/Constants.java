...
public class Constants {
    ...
    public static final String INVALID_AN_TASK_ID = "is invalid an task id. task id must be a integer";
    public static final String INVALID_ARGUMENT = "is a invalid argument";
    ...
    public static final Map<String, Set<Integer>> TASK_ARGUMENTS_LIST_MAP = new HashMap<>() {{
